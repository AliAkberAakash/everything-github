 ...
 * Use the [GithubRepoDetailsFragment.newInstance] factory method to
...
class GithubRepoDetailsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GithubRepoDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GithubRepoDetailsFragment().apply {
